...
# -*- coding: utf-8 -*-
"""
Upload Correct HTML Files
Качване на правилните HTML файлове
"""
...
def upload_correct_html():
    """Качва правилните HTML файлове"""
    print("📤 КАЧВАНЕ НА ПРАВИЛНИТЕ HTML ФАЙЛОВЕ")
    print("="*50)
    ...
    try:
        ...
        # Създаване на временни файлове локално
