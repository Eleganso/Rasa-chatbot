...
# -*- coding: utf-8 -*-
"""
Create Web Dirs and Upload
Създаване на web директории и качване на файлове
"""
...
def create_web_dirs_and_upload():
    """Създава web директории и качва файлове"""
    print("📁 СЪЗДАВАНЕ НА WEB ДИРЕКТОРИИ И КАЧВАНЕ")
    print("="*50)
    ...
    try:
        ...
        # Създаване на web директории
        print("\n📁 Създаване на web директории...")
        for bot_id, bot_path in bot_paths.items():
            print(f"\n🤖 Създаване на web директория за {bot_configs[bot_id]['name']}...")
            ssh.exec_command(f"mkdir -p /root/multi-bots/bots/{bot_path}/web")
            print(f"   ✅ Създадена директория: /root/multi-bots/bots/{bot_path}/web")
